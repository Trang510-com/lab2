...
// ✅ Đã cấu hình chân Bluetooth an toàn tránh chân I2C
#define RXD2 15
#define TXD2 23
...
#define BASE_SETPOINT (180.0-0.2)
...
PID pid(&input, &output, &setpoint, 23.5, 0.0, 1.3, DIRECT);

// CHÚ Ý 2: Hướng Xoay (Yaw) đặt DIRECT để bù lực xoay chéo bánh xe
PID rot(&yinput, &youtput, &ysetpoint, 3.2, 0.0, 0.1, DIRECT);
...
PID vel(&vInput, &vOutput, &vSetpoint, 0.13, 0.008, 0.00, DIRECT);
